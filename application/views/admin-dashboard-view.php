<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pr-0 pl-0">
  <div class="container-fluid admn-dbrd-main">
    <div class="row mt-30">
      <div class="col-lg-4 col-md-4 col-12  pt-30 admn-dbrd-card-main">
        <a href="#">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-8 text-right clr-light">
                  <h5 class="font-weight-bold">Total Customers</h5>
                  <h4 class="font-weight-bold"><?php echo $info['customers']; ?></h4>
                </div>
              </div>
          ...
          <div class="card bg-mainclr">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-8 text-right clr-light">
                  <h5 class="font-weight-bold">Total Stylists</h5>
                  <h4 class="font-weight-bold"><?php echo $info['stylist']; ?></h4>
                </div>
              </div>
