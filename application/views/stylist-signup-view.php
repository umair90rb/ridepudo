<section id="signUp" class="container-fluid bg-img1">
		...
		<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 srch-box-cntnr">
			<div class=" srch-box signup-box mb-80 mt-80 text-center">
				<form id="signup_form" autocomplete="off">
					<h3 class="text-bold f-18 clr-light">Set up your online shop <br>and increase your local presence</h3>
					...
					<input type="hidden" name="signup_for" value="stylist">
				</form>
