  ...
  <div class="container-fluid admn-dbrd-main">
    <div class="row mt-30">
      <div class="col-12 text-right">
        <button type="button" class="btn bg-primary lh-1 clr-light" id="create_user" data-toggle="modal" data-target="#UserModal"><i class="fas fa-plus"></i> Add Stylist</button>
      </div>
      ...
      <div class="modal-content">
          <div class="modal-body">
            ...
            <form class="px-4 py-3" id="CreateuserForm">
              ...
              <h3>Create <span class="clr-primary">Stylist</span></h3>
              <hr>
              ...
              <div class="form-group">
                ...
                <input id="shop_name" type="text" class="form-control" name="shop_name" placeholder="Enter Shop Name">
              </div>
              <div>
                <input type="hidden" name="user_type" value="4">
                <button type="button" id="btn_register" class="btn btn-dark mt-20" onclick="create_user();">Create Stylist</button>
              </div>
            </form>
        </div>
        </div>
...
<script src="<?php echo base_url(); ?>rp_assets/custom_js/admin_stylist.js?v=2.0"></script>