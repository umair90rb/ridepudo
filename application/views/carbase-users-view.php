  ...
  <div class="container-fluid admn-dbrd-main">
    <div class="row mt-30">
      <div class="col-12 text-right">
        <button type="button" class="btn bg-primary lh-1 clr-light" id="create_user" data-toggle="modal" data-target="#UserModal"><i class="fas fa-plus"></i> Add Users</button>
      </div>
      ...
      <div class="modal-content">
          <div class="modal-body">
            ...
            <form class="px-4 py-3" id="CreateuserForm">
              ...
              <h3>Create <span class="clr-primary">User</span></h3>
              <hr>
              ...
              <div>
                <input type="hidden" class="form-control" name="carbase_id" value="<?php echo $carbase_id; ?>">
                <input type="hidden" name="user_type" value="2">
                <button type="button" id="btn_register" class="btn btn-dark mt-20" onclick="create_user();">Create User</button>
              </div>
            </form>
        </div>
        </div>
...
<script src="<?php echo base_url(); ?>rp_assets/custom_js/carbase.js?v=2.0"></script>