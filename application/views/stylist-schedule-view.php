...
<div class="container-fluid">
	<div class="row">
		<div class="col-xl-3 col-lg-4 col-md-5  pt-80 pb-20 bg-gray2">
	      <div class="pt-3">
		...
		<div role="main" class="col-xl-9 col-lg-8 col-md-7 pb-20 schdl-cntnr bg-light">
			<div class="container-fluid ntfcn-cntnr">
				...
				<div class="row">
					...
					<div class="col-lg-7 col-12">
						<p class="mb-0 mt-20 f-18 text-bold clr-primary">Fade with Sarah Thompson</p>
						...
						<div class="container-fluid">
							<div class="row mt-20 scdl-srvc-img-sec">
								<div class="col-xl-3 col-lg-5 col-md-4 col-6 text-center text-bold">
