...
<main role="main" id="driverProfile" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 bg-light main-sec">
	<div class="container-fluid pro-sec-cntnr">
		...
		<div class="row">
			<div class="col-xl-2 col-lg-3 col-md-4 col-12 mb-20">
				<div class="img-div-main">
					<div class="img-div">
						...
						<form method="post" enctype="multipart/form-data" id="profile_image_form" action="<?php echo base_url(); ?>driver_profile/upload_profile_image" style="display: none;">
			...
			<div class="col-lg-9 col-md-9 col-12 pro-dsply-info">
...
<script src="<?php echo base_url(); ?>rp_assets/custom_js/driver_profile.js?v=2.0"></script>