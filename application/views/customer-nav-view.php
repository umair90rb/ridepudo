...
<nav class="navbar navbar-expand-lg navbar-expand-sm navbar-dark bg-dark fixed-top">
  	...
  	<div class="collapse navbar-collapse" id="navbarsExample05">
	    <ul class="navbar-nav ml-auto">
		    ...
		    <!-- <li class="nav-item brdr-r <?php if ($module == "schedule-view") { echo "active";} ?>">
		    ...
		    <li class="nav-item mr-20">
	      		...
	      		<div class="dropdown-menu animate slideIn dropdownNotify" aria-labelledby="dropdownUserLink">
					<!-- <a class="dropdown-item" href="<?php echo base_url(); ?>customer_profile">Profile</a> -->
	    ...
	    <div class="modal-content">
	      	<div class="modal-body">
	        	<div class="login-box">
					...
					<p><b>Step 6:</b> When your driver drops you to your appointment, you will have 2 ride back options: Schedule a Pick Up time or Request a Pick up time when ready.</p>

					<p>Scheduling a pick up time is when you want your driver to be outside ready for you, so be cautious and try to ask your cosmetologist of an appropriate time.</p>

					<p>Requesting a pick up time is when you and your cosmetologist can't really judge the appointment end time. You can request a driver whenever you feel the time is right. As soon as you request a driver one will be sent to you.</p>

					<p><i>**One way trips are OK but Roundtrip Services are our specialty, so be sure click one way or roundtrip upon checkout.</i></p>

					<p><b>Step 7:</b> Enjoy your Ride :)<p>
				</div>
			</div>
		</div>
	</div>
