...
if (empty($info['services']) || empty($info['details']) ) {
	$reminder = 1;
} else {
	$reminder = 0;
}
...
?>
<main id="ShopView" class="bg-light pt-100 pb-50" style="min-height: 641px;">
	<div class="container">
		<div class="row">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-6 col-md-5 col-12">
							<div class="shop-profile-image border border-dark" style="background-image: url('<?php echo base_url(); ?>rp_assets/Images/user_images/<?php echo $user['file_name']; ?>')">
						...
						<div class="col-lg-6 col-md-7 col-12">
							<p class="text-bold clr-primary f-25 mt-10 mb-0"><?php echo $user['first_name']; ?> <?php echo $user['last_name']; ?></p>
							...
							<a href="<?php echo base_url(); ?>stylist_profile" class="btn btn-dark bg-dark">Edit Shop Details</a>
						</div>
					</div>
				</div>
				<hr>
			...
			<div class="row">
				<div class="col-lg-5">
					...
					<div class="rtng-mtr mt-10">
						<div class="row">
							<div class="col-lg-3 col-md-2 col-4"><label>5 Stars</label></div>
						...
						<div class="row">
							<div class="col-lg-3 col-md-2 col-4"><label>4 Stars</label></div>
							<div class="col-lg-9 col-md-10 col-8">
								<div class="progress">
						...
						<div class="row">
							<div class="col-lg-3 col-md-2 col-4"><label>3 Stars</label></div>
							<div class="col-lg-9 col-md-10 col-8">
								<div class="progress">
						...
						<div class="row">
							<div class="col-lg-3 col-md-2 col-4"><label>2 Stars</label></div>
							<div class="col-lg-9 col-md-10 col-8">
								<div class="progress">
						...
						<div class="row">
							<div class="col-lg-3 col-md-2 col-4"><label>1 Stars</label></div>
							<div class="col-lg-9 col-md-10 col-8">
								<div class="progress">
				...
				<div class="col-lg-7 col-12">
					...
					<div class="myshop-img-sec">
						<div class="row">
							<div class="col-md-3  col-6 mt-10">
...
<div class="modal fade" id="reminder_modal" tabindex="-1" role="dialog">
  	<div class="modal-dialog modal-md" role="document">
	    <div class="modal-content">
	      	<div class="modal-content">
              <div class="modal-header bg-purple clr-white">
              ...
              <div class="modal-footer">
                <a href="<?php echo base_url(); ?>stylist_profile" class="btn bg-purple clr-white">Update Profile</a>
                <button type="button" class="btn btn-default bg-grey clr-white" data-dismiss="modal">Close</button>
              </div>
            </div>
	    </div>
  	</div>
