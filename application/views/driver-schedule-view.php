...
<div class="container-fluid">
	<div class="row">
		<div class="col-xl-3 col-lg-4  pt-80 pb-20 bg-gray2">
	      <div class="pt-3">
		...
		<div role="main" class="col-xl-9 col-lg-8 pb-20 schdl-cntnr bg-light">
					...
					<div class="col-lg-7 col-md-7 col-12">
						...
						<div class="container-fluid">
							<div class="row mt-20 scdl-srvc-img-sec">
								<div class="col-lg-3 col-md-3 text-center text-bold">
