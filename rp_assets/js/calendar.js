...
onClose: $.noop
        ...
        TEMPLATE = [
            ...
            '<span class="prev" title="Prev" data-calendar-arrow-date><i class="fa fa-angle-left"></i></span>',
            '<span class="next" title="Next" data-calendar-arrow-date><i class="fa fa-angle-right"></i></span>',
            '</div>',
            '</div>',
            ...
            '<div class="calendar-arrow">',
            '<span class="prev" title="Prev" data-calendar-arrow-month><i class="fa fa-angle-left"></i></span>',
            '<span class="next" title="Next" data-calendar-arrow-month><i class="fa fa-angle-right"></i></span>',
            '</div>',
            '</div>',
